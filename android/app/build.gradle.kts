...
fun mergeLocalDartDefines(project: org.gradle.api.Project) {
    ...
    // Never auto-merge local dev defines into release builds.
    val taskNames = project.gradle.startParameter.taskNames.joinToString(" ")
    if (taskNames.contains("Release", ignoreCase = true) ||
        taskNames.contains("appbundle", ignoreCase = true)
    ) {
        return
    }
...
android {
    ...
    defaultConfig {
        applicationId = "com.rafiqalhajj.app"
