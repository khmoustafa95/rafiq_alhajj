...
/// scoped to [typeScope].
class AdminContentFeedTab extends ConsumerStatefulWidget {
  const AdminContentFeedTab({required this.typeScope, super.key});

  final ContentType typeScope;

  @override
  ConsumerState<AdminContentFeedTab> createState() => _AdminContentFeedTabState();
}

class _AdminContentFeedTabState extends ConsumerState<AdminContentFeedTab>
  ...
  late final StaffTableDefinitionCache<ContentItem> _tableDefs =
    ...
    buildColumns: _buildFeedColumns,
    buildFilters: _buildFeedFilters,
  );
...
List<StaffTableFilter> _buildFeedFilters(AppLocalizations l10n) {
  return [
    StaffTableFilter(
      id: 'visibility',
...
List<StaffTableColumn<ContentItem>> _buildFeedColumns(AppLocalizations l10n) {
  return [
    StaffTableColumn(
      id: 'title',
