...
import 'package:rafiq_alhajj/features/admin_content/presentation/widgets/admin_content_edit_form.dart';
    ...
    return StaffAdaptivePage(
      web: StaffWebPage(
        ...
        body: AdminContentEditForm(
          ...
          onNotifyChanged: (v) => setState(() => _notifyPilgrims = v),
          onUploadCover: _uploadMedia,
        ),
