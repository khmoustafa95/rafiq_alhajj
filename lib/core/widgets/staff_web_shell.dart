...
class _StaffWebShellState extends ConsumerState<StaffWebShell> {
  ...
  List<_StaffNavItem> _adminNavItems(AppLocalizations l10n, String location) {
    return [
      ...
      _StaffNavItem(
        ...
        label: l10n.staffNavAdmins,
        route: AppRoutes.adminAccounts,
        isActive: location.startsWith(AppRoutes.adminAccounts),
      ),
      _StaffNavItem(
  ...
  String _pageTitle(AppLocalizations l10n, String location, bool isAdmin) {
    ...
    if (location.startsWith(AppRoutes.adminAccounts)) {
      return l10n.adminAccountsTitle;
    }
